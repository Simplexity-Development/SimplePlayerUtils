    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (sender.hasPermission(SPUPerm.WALKSPEED_OTHERS.getPerm()) && args.length == 2){
            ...
            if (args[1].equalsIgnoreCase("reset")) {
                ...
                sender.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_RESET_OTHER.getMessage(),
                        Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
                        Placeholder.component("user", player.displayName())));
                player.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_RESET_BY_OTHER.getMessage(),
                        Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
            ...
            if (args[1].equalsIgnoreCase("get")) {
                sender.sendMessage(miniMessage.deserialize(SPUMessage.OTHER_CURRENT_WALKSPEED.getMessage(),
                        Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
                        Placeholder.component("user", player.displayName()),
                        Placeholder.parsed("value", String.valueOf(player.getWalkSpeed() * 10))));
                return true;
            }
            ...
            sender.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_SET_OTHER.getMessage(),
                    Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
                    Placeholder.parsed("value", args[1]),
                    Placeholder.component("user", player.displayName())));
            player.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_SET_BY_OTHER.getMessage(),
                    Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
                    Placeholder.parsed("value", args[1]),
                    Placeholder.component("sender", senderName)));
            return true;
        ...
        if (args.length == 0 ||args[0].equalsIgnoreCase("get")) {
            playerSender.sendMessage(miniMessage.deserialize(SPUMessage.OWN_CURRENT_WALKSPEED.getMessage(),
                    Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
                    Placeholder.parsed("value", String.valueOf(playerSender.getWalkSpeed() * 10))));
            return true;
        }
        ...
        if (args[0].equalsIgnoreCase("reset")) {
            ...
            playerSender.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_RESET.getMessage(),
                    Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage())));
            return true;
        }
        ...
        sender.sendMessage(miniMessage.deserialize(SPUMessage.WALKSPEED_SET.getMessage(),
                Placeholder.parsed("plugin_prefix", SPUMessage.PLUGIN_PREFIX.getMessage()),
