...
public class LocaleBuilder {
        ...
        public void setDefaults() {
            ...
            config.addDefault("error-no-valid-player-supplied","<plugin_prefix> <red>No valid player was supplied. <target> is not the name of a valid online player, please check your spelling and try again");
            ...
            config.addDefault("anvil-command-other","<plugin_prefix> <gray>Anvil opened for <target>");
            config.addDefault("cartography-command-other","<plugin_prefix> <gray>Cartography table opened for <target>");
            config.addDefault("craft-command-other","<plugin_prefix> <gray>Crafting table opened for <target>");
            config.addDefault("enderchest-command-other","<plugin_prefix> <gray>Enderchest opened for <target>");
            config.addDefault("loom-command-other","<plugin_prefix> <gray>Loom opened for <target>");
            config.addDefault("smithing-command-other","<plugin_prefix> <gray>Smithing table opened for <target>");
            config.addDefault("stonecutter-command-other","<plugin_prefix> <gray>Stonecutter opened for <target>");
            config.addDefault("grindstone-command-other","<plugin_prefix> <gray>Grindstone opened for <target>");
            ...
            config.addDefault("fly-enabled-other","<plugin_prefix> <green>You have enabled flight for <target>");
            config.addDefault("fly-disabled-other","<plugin_prefix> <gray>You have disabled flight for <target>");
            config.addDefault("fly-enabled_by-other","<plugin_prefix> <green><initiator> has enabled flight for you");
            config.addDefault("fly-disabled_by-other","<plugin_prefix> <gray><initiator> has disabled your flight");
            config.addDefault("other-current-walkspeed","<plugin_prefix> <target>'s current walkspeed is <value>");
            ...
            config.addDefault("walkspeed-set-other","<plugin_prefix> <green>You set <target>'s walkspeed to <value>");
            config.addDefault("walkspeed-reset-other","<plugin_prefix> <green><target>'s walkspeed has been reset");
            config.addDefault("walkspeed-set_by-other","<plugin_prefix> <green>Your walkspeed has been set to <value> by <initiator>");
            config.addDefault("walkspeed-reset-by-other","<plugin_prefix> <green>Your walkspeed has been reset by <initiator>");
            config.addDefault("other-current-flyspeed","<plugin_prefix> <target>'s current flyspeed is <value>");
            ...
            config.addDefault("flyspeed-set-other","<plugin_prefix> <green>You set <target>'s flyspeed to <value>");
            config.addDefault("flyspeed-reset-other","<plugin_prefix> <green><target>'s flyspeed has been reset");
