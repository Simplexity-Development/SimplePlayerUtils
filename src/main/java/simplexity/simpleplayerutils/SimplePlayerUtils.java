package simplexity.simpleplayerutils;

import net.kyori.adventure.text.minimessage.MiniMessage;
import org.bukkit.plugin.java.JavaPlugin;
import simplexity.simpleplayerutils.commands.*;
import simplexity.simpleplayerutils.commands.inventories.*;
import simplexity.simpleplayerutils.config.Defaults;
import simplexity.simpleplayerutils.config.LocaleBuilder;
import simplexity.simpleplayerutils.listeners.AFKListener;
import simplexity.simpleplayerutils.listeners.ChatListener;
import simplexity.simpleplayerutils.listeners.FlyListeners;
import simplexity.simpleplayerutils.listeners.InventoryCloseListener;
import simplexity.simpleplayerutils.util.SPUExpansion;
import simplexity.simpleplayerutils.util.SPUMessage;
import simplexity.simpleplayerutils.util.SPUPerm;
import simplexity.simpleplayerutils.util.SPUSound;
